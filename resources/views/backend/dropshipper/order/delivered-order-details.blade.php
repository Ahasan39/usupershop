                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <table class="text-center myTable" border="1" width="100%">
                                        <tr>
                                            ...
                                            <td width="40%">
                                                ...
                                                <span><strong>Whatsapp No : </strong> 01894448136</span><br>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   @php
                                                    ...
                                                    @endphp
                                                    {{ $details->quantity }} X {{ $details->sell_price }} = {{ $sub_total }} Tk.
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align: right;"><strong>Grand Total : </strong>
                                            </td>
                                ...
                                <!-- <a id="approve" class="btn btn-sm btn-primary float-right mt-3"
                                                ...
                                                data-id="{{ $order->id }}"><i class="fas fa-check"></i> Approved</a> -->
