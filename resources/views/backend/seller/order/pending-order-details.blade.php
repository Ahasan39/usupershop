                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-4 text-center text-md-right">
                                            ...
                                            <p class="mb-0"><strong>Status:</strong> <span
                                                    class="badge badge-warning">Pending</span></p>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                @foreach ($order['order_details'] as $index => $details)
                                                    ...
                                                    @endphp
                                                    <tr>
                                                        <td style="width: 50px; min-width: 50px;">{{ $loop->iteration }}
                                                        </td>
                                                        <td style="min-width: 200px;">{{ $details['product']['name'] }}
                                                        </td>
                                                        ...
                                                        <td class="text-center" style="width: 70px; min-width: 70px;">
                                                            {{ $details->quantity }}</td>
                                                        <td class="text-right" style="width: 120px; min-width: 120px;">
                                                            {{ number_format($details->sell_price, 2) }}
                                                        </td>
                                                        <td class="text-right" style="width: 130px; min-width: 130px;">
