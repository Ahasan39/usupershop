                            ...
                            <div class="card-header">
                                <h5>
                                    ...
                                    <a class="btn btn-sm btn-primary float-right"
                                        href="{{ route('seller.orders.pending.list') }}"><i class="fas fa-list"></i> Delivered Order
                                        List</a>
                                </h5>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <div class="table-responsive">
                                    <table class="text-center myTable" border="1" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>{{ round($order->order_total - $order->coupon_discount + $order['area']['deliveryCharge']) }}
                                                    Tk.</strong></td>
                                        </tr>
                                    </table>
                                </div>
