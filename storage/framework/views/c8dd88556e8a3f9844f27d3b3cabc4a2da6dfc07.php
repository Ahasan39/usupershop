    ...
    <script>
        $(function() {
            $("#penOrderTbl").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('seller.orders.rlist')); ?>",
                    data: function(data) {
                        let customFilter = {};
...
<?php echo $__env->make('backend.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\webleez works\u super project\usupershop_v2\resources\views/backend/seller/order/return-list.blade.php ENDPATH**/ ?>