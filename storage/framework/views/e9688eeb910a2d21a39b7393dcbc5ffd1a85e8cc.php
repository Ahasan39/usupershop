...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('frontend')); ?>/images/icons/favicon.png" />
    ...
    <script src="<?php echo e(asset('backend')); ?>/sweetalert/sweetalert.js"></script>
    <link href="<?php echo e(asset('backend')); ?>/sweetalert/sweetalert.css" rel="stylesheet" type="text/css" />
    <!-- Select2 -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <!-- <img class="animation__shake" src="<?php echo e(asset('backend')); ?>/dist/img/AdminLTELogo.png" alt="AdminLTELogo"
                height="60" width="60" /> -->
            <img style="width: 80px;height:80px"
                src="<?php echo e(!empty(Auth::user()->image) ? url('public/upload/user_images/' . Auth::user()->image) : url('public/upload/profile.jpg')); ?>"
            ...
            <ul class="navbar-nav">
                ...
                <?php if(auth()->user()->payment_status == 1): ?>
                    <?php if(auth()->user()->usertype === 'seller'): ?>
                        ...
                        <textarea type="text" id="password" class="form-control d-none" rows="2" cols="4"><?php echo e(route('seller.signup')); ?>?refer=<?php echo e(auth()->user()->refer_code); ?></textarea>
                    <?php endif; ?>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="<?php echo e(route('seller.dashboard')); ?>" class="brand-link">
                <img src="<?php echo e(asset('backend//dist/img/AdminLTELogo.png')); ?>"
                    alt="<?php echo e(Auth::user()->shop_name ?? ''); ?>" class="brand-image img-circle elevation-3"
            ...
            <div class="sidebar">
                ...
                <div style="background: #dc3545" class="user-panel d-flex">
                    <div class="image mt-2">
                        <img src="<?php echo e(!empty(Auth::user()->logo) ? url('public/upload/user_images/' . Auth::user()->logo) : url('public/upload/profile.jpg')); ?>"
                            class="img-circle elevation-2" alt="User Image" />


                    </div>
                    <div class="info">
                        <a href="<?php echo e(route('sellers.view.profile')); ?>" class="d-block"><?php echo e(Auth::user()->name); ?>

                            (<?php echo e(Auth::user()->balance); ?>)</a>
                        <span class="d-block text-white"> <?php echo e(Auth::user()->shop_name ?? 'shop name'); ?>

                        </span>
                        <span class="d-block text-white"> Balance: <?php echo e(Auth::user()->balance); ?>

                        </span>
                        <span class="d-block text-white text-uppercase"> <?php echo e(Auth::user()->usertype ?? 'usertype'); ?>

                        </span>
                    </div>
                </div>
                <?php echo $__env->make('backend.seller.seller-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <!-- /.sidebar -->
        </aside>
        ...
        <?php if(session()->has('success')): ?>
            <script type="text/javascript">
                $(function() {
                    $.notify("<?php echo e(session()->get('success')); ?>", {
        ...
        <?php if(session()->has('error')): ?>
            <script type="text/javascript">
                $(function() {
                    $.notify("<?php echo e(session()->get('error')); ?>", {
                        globalPosition: 'top right',
                        className: 'error'
                    });
                });
            ...
            <div class="container-fluid px-0">
                <ul class="nav nav-pills w-100 d-flex justify-content-around align-items-center" role="tablist">
                    ...
                    <li class="nav-item text-center flex-grow-1">
                        <a class="nav-link py-2 px-1 d-flex flex-column align-items-center <?php echo e(request()->routeIs('dropshipper.shopkeeper_product') ? 'active' : ''); ?>"
                            href="<?php echo e(route('dropshipper.shopkeeper_product')); ?>">
                    ...
                    <!-- Order Track -->
                    <li class="nav-item text-center flex-grow-1">
                        <a class="nav-link py-2 px-1 d-flex flex-column align-items-center <?php echo e(request()->routeIs('dropshipper.orders.pending.list') ? 'active' : ''); ?>"
                            href="<?php echo e(route('dropshipper.orders.pending.list')); ?>">
                    ...
                    <li class="nav-item text-center flex-grow-1">
                        <a class="nav-link py-2 px-1 d-flex flex-column align-items-center <?php echo e(request()->routeIs('dropshipper.dashboard') ? 'active' : ''); ?>"
                    ...
                    <!-- My Cart -->
                    <li class="nav-item text-center flex-grow-1">
                        <a class="nav-link py-2 px-1 d-flex flex-column align-items-center <?php echo e(request()->routeIs('show.cart') ? 'active' : ''); ?>"
                            href="<?php echo e(route('show.cart')); ?>">
                    ...
                    <!-- Me -->
                    <li class="nav-item text-center flex-grow-1">
                        <a class="nav-link py-2 px-1 d-flex flex-column align-items-center <?php echo e(request()->routeIs('dropshipper.view.profile') ? 'active' : ''); ?>"
        ...
        <footer class="main-footer">
            <strong>Copyright &copy;
                <a href="<?php echo e(route('frontend.home')); ?>" target="_blank">U Super Shop</a>.</strong>
    ...
    <script src="<?php echo e(asset('backend')); ?>/plugins/jquery-validation/additional-methods.min.js"></script>
    ...
    <script type="text/javascript">
        function addToMyShop(product_id) {
            $.ajax({
                type: "GET",
                dataType: 'json',
                url: "<?php echo e(url('/sellers/add-to-my-shop/')); ?>/" + product_id,
                success: function(data) {
                    //  start message
...
<?php /**PATH D:\webleez works\u super project\usupershop_v2\resources\views/backend/seller/seller-master.blade.php ENDPATH**/ ?>